...
from src.core.constants import MAX_RETRIES, TDATA_DIR, KEY_FOLDER
...
def restore_default(max_retries: int = MAX_RETRIES, target_folder: Optional[str] = None, temp_name: Optional[str] = None) -> bool:
    """还原默认账户。"""
    return _account_switch("restore", max_retries, target_folder=target_folder, temp_name=temp_name)


def switch_to_tag(max_retries: int = MAX_RETRIES, confirm_callback: Optional[Callable[[str], bool]] = None,
                  target_folder: Optional[str] = None, temp_name: Optional[str] = None) -> bool:
    """切换到指定标签账户。"""
    return _account_switch("target", max_retries, confirm_callback, target_folder, temp_name)


def _account_switch(method: Literal["restore", "target"], max_retries: int = MAX_RETRIES,
                    confirm_callback: Optional[Callable[[str], bool]] = None,
                    target_folder: Optional[str] = None,
                    temp_name: Optional[str] = None) -> bool:
    """执行账户切换流程。"""
