...
from src.core.constants import MUTEX_PREFIX, SINGLE_INSTANCE_LOCK_NAME
...
class SingleInstanceLock:
    ...
    def __init__(self, lock_name: str = SINGLE_INSTANCE_LOCK_NAME) -> None:
        """初始化锁."""
    ...
    def _init_windows(self) -> None:
        ...
        self._handle = _kernel32.CreateMutexW(None, wintypes.BOOL(False), self._mutex_name)
        if not self._handle:
    ...
    def acquire(self, timeout: float = 0) -> bool:
        ...
        result = _kernel32.WaitForSingleObject(self._handle, wintypes.DWORD(timeout_ms))
        ...
        if result == WAIT_OBJECT_0:
            ...
            raise SingleInstanceException(f"等待互斥体失败，错误码: {ctypes.get_last_error()}")
